...
public class EventMessageIdSerializer {
    ...
    private static void collectMapping(Set<StoredMessageId> msgIds, Map<String, Short> aliasMapping, Counter size, Counter counter) {
    ...
    private static void writeMessageIds(Set<StoredMessageId> msgIds, Map<String, Short> aliasMapping, ByteBuffer buffer) {
        for (StoredMessageId msgId : msgIds) {
