...
public class BatchedStoredTestEventBuilder {
	...
	public BatchedStoredTestEventBuilder setStartTimestamp(Instant startTimestamp) {
	...
	public BatchedStoredTestEvent build() {
		return new BatchedStoredTestEvent(this.id, this.name, this.type, this.parentId, this.startTimestamp, 
				this.endTimestamp, this.success, this.content, this.batch);
	}
}
