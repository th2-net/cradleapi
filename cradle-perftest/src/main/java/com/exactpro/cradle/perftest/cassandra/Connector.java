 ...
 */
package com.exactpro.cradle.perftest.cassandra;
...
public class Connector implements AutoCloseable {
    ...
    public static Connector connect(String host, Integer port, String username, String password, String localDataCenter) {
        return connect(host, port, username, password, localDataCenter, null);
    }
