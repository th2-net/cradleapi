...
public interface PageSessionsOperator {
	...
	@Select
	CompletableFuture<MappedAsyncPagingIterable<PageSessionEntity>> getAsync(String book, String page, Function<BoundStatementBuilder, BoundStatementBuilder> attributes);
