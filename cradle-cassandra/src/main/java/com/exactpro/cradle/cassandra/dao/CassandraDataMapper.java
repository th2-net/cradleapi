...
public interface CassandraDataMapper
{
	...
	@DaoFactory
	StatisticsOperator createStatisticsOperator(@DaoKeyspace String keyspace, @DaoTable String statisticsTable);
	...
	@DaoFactory
	StatisticsEntityConverter statisticsEntityConverter();
}
