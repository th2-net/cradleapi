...
public class DuplicateSkippingConvertingPagedIterator<R, E> extends ConvertingPagedIterator<R, E>{

    private final Set<R> registry;
    private R preFetchedElement;

    public DuplicateSkippingConvertingPagedIterator(MappedAsyncPagingIterable<E> rows,
