...
public class PageEntity
{
	...
	public PageEntity(String name, Instant started, String comment, Instant ended)
	{
		...
		this.part = Integer.toString(startedLdt.getYear());
	...
	public PageInfo toPageInfo(BookId bookId)
	{
		return new PageInfo(new PageId(bookId, name), getStartTimestamp(), getEndTimestamp(), getComment());
	}
}