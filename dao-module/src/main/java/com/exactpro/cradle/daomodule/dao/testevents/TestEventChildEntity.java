...
import com.exactpro.cradle.cassandra.dao.testevents.TestEventWithParentMetadataEntity;
...
public class TestEventChildEntity extends TestEventWithParentMetadataEntity
{
	...
	public TestEventChildEntity(StoredTestEvent event, UUID instanceId) throws IOException
	{
