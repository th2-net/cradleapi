...
public class DetailedMessageBatchEntity extends MessageBatchEntity
{
	...
	{
		return LocalDateTime.of(getStoredDate(), getStoredTime()).toInstant(StorageConstants.TIMEZONE_OFFSET);
	}
	
	@Transient
	public void setStoredTimestamp(Instant timestamp)
	{
		LocalDateTime ldt = LocalDateTime.ofInstant(timestamp, StorageConstants.TIMEZONE_OFFSET);
	...
	{
		return LocalDateTime.of(getFirstMessageDate(), getFirstMessageTime()).toInstant(StorageConstants.TIMEZONE_OFFSET);
	}
	...
	{
		return LocalDateTime.of(getLastMessageDate(), getLastMessageTime()).toInstant(StorageConstants.TIMEZONE_OFFSET);
	}
